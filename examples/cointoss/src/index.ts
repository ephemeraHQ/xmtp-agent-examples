...
import { initializeAgent, processMessage } from "./cdp";
import { initializeStorage, initializeStorage as initStorage } from "./storage";
...
async function handleMessage(
  ...
  const { agent, config } = await initializeAgent(xmtpUser, storage);
